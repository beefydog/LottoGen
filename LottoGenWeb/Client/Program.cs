...
//        var apiSettings = await httpClient.GetFromJsonAsync<ApiSettings>("appsettings.json");

//        builder.Services.AddSingleton(sp => new HttpClient { BaseAddress = new Uri(apiSettings.BaseAddress) });
